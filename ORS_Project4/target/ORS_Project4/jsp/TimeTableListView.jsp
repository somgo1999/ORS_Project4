<%@page import="com.rays.project.model.TimeTableModel"%>
<%@page import="com.rays.project.controller.TimeTableListCtl"%>
<%@page import="com.rays.project.util.DataUtility"%>
<%@page import="com.rays.project.util.HTMLUtility"%>
<%@page import="com.rays.project.bean.TimeTableBean"%>
...
<body>
	<jsp:useBean id="bean" class="com.rays.project.bean.TimeTableBean"
