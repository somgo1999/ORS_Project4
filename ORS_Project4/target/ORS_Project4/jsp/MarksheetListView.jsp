...
<%@page import="com.rays.project.model.MarksheetModel"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.project.util.ServletUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.project.bean.MarksheetBean"%>
<%@page import="com.rays.project.controller.MarksheetListCtl"%>
...
<body>
	<jsp:useBean id="bean" class="com.rays.project.bean.MarksheetBean"
