...
<%@page import="com.rays.project.model.CourseModel"%>
<%@page import="com.rays.project.util.HTMLUtility"%>
<%@page import="com.rays.project.controller.CourseListCtl"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.project.bean.CourseBean"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.project.controller.CourseCtl"%>
...
<body>
	<jsp:useBean id="bean" class="com.rays.project.bean.CourseBean"
