...
public class EmailUtility {
	...
	//resourcebundle's instance to get its properties from the system.properties
	static ResourceBundle rb = ResourceBundle.getBundle("com.rays.project.resourceBundle.system");

	/**
	 * Email Server
	 */

	//gmail.com from the system.properties
	...
	//google port number from the system.properties
	...
	//sender's email id from the system.properties
	...
	//email password value from the system.properties
	...
	//created properties class object so that we could store string(key/value) pairs while hashmap stores in form of objects 
