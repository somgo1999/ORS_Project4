...
<%@page import="com.rays.project.controller.SubjectListCtl"%>
<%@page import="com.rays.project.util.ServletUtility"%>
<%@page import="com.rays.project.bean.SubjectBean"%>
<%@page import="com.rays.project.bean.CourseBean"%>
<%@page import="java.util.List"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.project.model.SubjectModel"%>
<%@page import="com.rays.project.model.StudentModel"%>
...
<body>
	...
	<div align="center">
		...
		<jsp:useBean id="bean" class="com.rays.project.bean.SubjectBean"
