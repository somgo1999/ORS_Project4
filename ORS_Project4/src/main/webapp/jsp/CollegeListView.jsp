...
<%@page import="com.rays.project.model.CollegeModel"%>
<%@page import="com.rays.project.model.UserModel"%>
<%@page import="com.rays.project.bean.CollegeBean"%>
...
<%@page import="com.rays.project.controller.CollegeListCtl"%>
...
<body>
	<jsp:useBean id="bean" class="com.rays.project.bean.CollegeBean"
