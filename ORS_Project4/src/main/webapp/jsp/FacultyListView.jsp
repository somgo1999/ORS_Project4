<%@page import="com.rays.project.controller.ORSView"%>
<%@page import="com.rays.project.model.FacultyModel"%>
<%@page import="com.rays.project.bean.FacultyBean"%>
<%@page import="com.rays.project.util.HTMLUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.project.controller.FacultyListCtl"%>
<%@page import="com.rays.project.util.DataUtility"%>
<%@page import="com.rays.project.util.ServletUtility"%>
<html>
<head>
...
<body>
	...
	<jsp:useBean id="bean" class="com.rays.project.bean.FacultyBean"
		scope="request"></jsp:useBean>
	<jsp:useBean id="colbean" class="com.rays.project.bean.CollegeBean"
		scope="request"></jsp:useBean>
	<jsp:useBean id="corbean" class="com.rays.project.bean.CourseBean"
		scope="request"></jsp:useBean>
