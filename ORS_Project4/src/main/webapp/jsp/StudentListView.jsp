...
<%@page import="com.rays.project.bean.StudentBean"%>
<%@page import="com.rays.project.controller.StudentListCtl"%>
...
<body>
	<jsp:useBean id="cbean" class="com.rays.project.bean.CollegeBean"
		scope="request"></jsp:useBean>
	<jsp:useBean id="bean" class="com.rays.project.bean.StudentBean"
		scope="request"></jsp:useBean>
